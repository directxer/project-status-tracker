...
**Goal:** Build a lightweight web application for tracking project status with add/remove/edit projects and subtasks using vanilla JavaScript, Tailwind CSS, and localStorage persistence.
